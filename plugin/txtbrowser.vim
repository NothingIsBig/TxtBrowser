...
if !exists('Txtbrowser_Search_Engine')
	if(v:lang == "zh_CN.utf-8")
		let Txtbrowser_Search_Engine = 'https://www.google.com.hk/search?q=text'
	else
		let Txtbrowser_Search_Engine = 'http://www.google.com/search?hl=zh-CN&source=hp&q=text'
	endif
endif
...
" vim:ft=vim:tw=78:ts=4:sw=4:sts=4:noexpandtab
